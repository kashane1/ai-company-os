"""Phase 3 structural contract test — verification-loop.

Same pattern as the Phase 1 research-first skills: parse each
fixture, assert required strings / sections / contract fields /
violations are present in the canonical markdown. Freezes the
CONTRACT, not any LLM-verdict run of the composed sub-checks.
"""
...
FIXTURES_DIR = (
    SKILLS_ROOT / "canonical" / "verification-loop" / "fixtures"
)
...
def test_verification_loop_contract(case: dict) -> None:

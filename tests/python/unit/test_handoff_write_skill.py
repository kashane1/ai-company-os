"""Anti-drift batch 2.1 structural contract test — handoff-write.
...
FIXTURES_DIR = SKILLS_ROOT / "canonical" / "handoff-write" / "fixtures"
...
def test_handoff_write_contract(case: dict) -> None:

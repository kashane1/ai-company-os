#!/usr/bin/env python3
"""Draft a Meta (Facebook/Instagram) Ads campaign (META_ADS.md) from client intake.

Example:
  python scripts/agency/draft_meta_ads.py --business "Joe's Plumbing" \\
...
def main() -> int:
    ...
    parser.add_argument("--out", type=Path, help="client docs dir → writes META_ADS.md")

...
Read and follow the skill instructions at `skills/adapters/claude/context-budget.md`.

That adapter implements `skills/canonical/context-budget/skill.md` — the canonical source of truth for this skill.

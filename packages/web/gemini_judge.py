...
def _prompt() -> str:
    ...
    return (
        ...
        "in a studio portfolio. DEFECT CHECK FIRST: if any section is a near-duplicate of "
        "another (e.g. the same hero image or headline shown twice down the page), that is a "
        "serious defect — score `layout_composition` 2 or lower and name it in the note. "
        "For `ai_house_style`, score 5 only if NONE of the cheap/AI "

...
enum TripEditingLogic {
    ...
    static func normalizedDouble(_ value: String) -> Double? {
        Double(normalizedText(value))
    }
    ...
    static func conditionDraft(
        ...
        TripConditionDraft(
            ...
            temperatureC: normalizedDouble(temperatureC),
            latitude: normalizedDouble(latitude),
            longitude: normalizedDouble(longitude)
        )
    }

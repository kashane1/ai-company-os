---
status: superseded
summary: Historical research-to-commerce implementation plan; do not execute. Replaced by the HomeFromWorking POD listing direction on 2026-09-02.
...
> Tasks, code examples, and execution instructions below are historical.

...
- "run the design studio on this" / "make this a premium build" / "elevate this demo" / "give this the five-figure treatment" / "art-direct this site" → `skills/adapters/claude/design-studio.md` (**opt-in premium track, select builds only** — packet → build → desktop/mobile screenshots → visual rubric review; rejects valid-but-generic pages. NOT for routine cold-outreach demos, which stay on `landing-page-build` / the bespoke playbook. If the user just wants a normal demo, ASK before routing here.)

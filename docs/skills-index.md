...
- "intake this client" / "capture the business details" / "start the client brief" / "onboard this client" → `skills/adapters/claude/client-intake.md` (Agency layer Phase 4; builds `ClientIntake`, renders `CLIENT_BRIEF.md`, produces a localized scaffold context; never deploys)

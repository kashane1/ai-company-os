...
> Batch B. **98 of 101 done** (9 "email" prospects + 89 "IG/FB"). **✅ IGFB WORKLIST COMPLETE — all 91 rows processed (89 built + 3 skipped).** (+3 skipped/flagged: Grupo Francie, Rodelas, Express Tax Notary)
> remain**, listed in `state/prospects/batches/IGFB-remaining-worklist.tsv` (✅ ALL 91 ROWS DONE — worklist complete (rows 64 + 69 + 90 SKIPPED/flagged; rest built)). **Chrome extension WORKS for Instagram (operator restarted it 2026-06-15);
...
86. AV Auto Technician `ChIJOQmSbJlZ54YRXonSYc_ODDA` (El Paso) — clean white-ground modern-technical auto-electric shop in their real brand: clean WHITE/light-gray ground + bold BLACK + signal-RED (the AV monogram) + steel, AV-monogram + check-engine/battery-spark/diagnostic-gauge motifs, Saira Condensed, mechanic Luis, auto-electric+check-engine+A/C+brakes, bilingual (7th auto build; the ONLY WHITE-ground one, distinct from all 6 dark siblings). INTEGRITY: 4.3/12 w/ one repair-didn't-hold/no-follow-up 1-star → show 4.3 (no perfect-5), NO guarantee/warranty/thoroughness claims; led honesty/explains-in-detail/fair; no prices.
87. J&A Landscapes LLC `ChIJFcSfhncTd6kRvLxYuTiFBp0` (Indianapolis) — grounded year-round full-service landscaper+hardscaper: deep SLATE/blue-gray + warm STONE/sandstone-tan + fresh leaf-GREEN accent + cream, leaf/paver-stone/tree/snowflake/checkmark motifs, Zilla Slab, 7+yrs, reliable (3rd landscaper; stone/slate-led hardscape+all-seasons, distinct from green-led Luv-It + charcoal Bermudez). 5.0/12; LED reliable-shows-up + year-round (mowing/snow/lights/trees/painting/hardscaping); no prices; 'open 24h' framed as responsive.
88. Soriel Music Academy `ChIJRQ2ruRS5woARstMNrVs0ndU` (Los Angeles) — refined classical-conservatory music academy in their real brand: deep NAVY/midnight + refined GOLD + cream + warm wood (their navy accent walls), violin/piano-keys/treble-clef/laurel/music-stand motifs, Cormorant, violin+piano+voice, credentialed faculty (doctorate; Kyuri/Amy), year-end recital (2nd music_lessons; navy classical-conservatory, distinct from Genesis soulful charcoal/plum Detroit). 5.0/12; no prices/invented-instruments.
89. Cardinal Pro Landscaping `ChIJWwvxYAN51oYRYiJb1MV9BhE` (Tucson) — desert/xeriscape + pavers crew with their real cardinal-bird brand: cardinal-RED + warm desert SAND/tan + sage + cream + charcoal, cardinal/paver/cactus/water-drop motifs, Zilla Slab, owner Jorge (4th landscaper; desert+cardinal-red, distinct from charcoal-Bermudez/green-Luv-It/slate-J&A). 4.3/12 (sampled all-5★ but avg below) → show 4.3 (no perfect-5); LED fair-spot-on-estimate + fast-finish + desert; no prices/snow; didn't reference free AJ microsite. (Build agent caught a photo mis-read: my 'hero-pavers' was actually their LOGO → it correctly led with the real patio + put logo in footer.)
90. Southie Auto Service (Auto Body Specialist) `ChIJiV24uGB644kRlb1uwnOwlLA` (South Boston) — old-school AUTO BODY/collision shop: deep Celtic/forest-GREEN + warm cream + brass-GOLD + charcoal, car-body/spray-paint/shine/subtle-shamrock motifs, Fraunces, owner Tony, before/after body work (8th auto build, 1st BODY shop; forest-green old-school-Southie, distinct from all 7 mechanic siblings). 5.0/11; LED honest-no-upsell + factory-new + fast + decades-in-Southie; NO phone exists (CTA=visit+FB, didn't invent one), no prices, BODY-services-only (no mechanical). Photos: real before/after, plates blurred/cropped.
91. Topaz and Rubies Pet Grooming `ChIJ6-m8WS6JOIgRLxHf2LDOsgk` (Columbus) — jewel-luxe grooming+boarding (their name=gems): topaz amber-GOLD + ruby-RED + deep plum-aubergine base + cream, faceted topaz/ruby-gem + paw/sparkle/crown motifs, Fraunces, owner/groomer Chris, dogs+cats (12th dog-care; two-gem topaz+ruby jewel theme, distinct from all 11 incl. Benji navy/gold-crown + Sweet Rascals cherry-red). INTEGRITY: 4.7/12 w/ one communication-mixup 1-star → show 4.7 (no perfect-5), NO communication/response claims; led grooming-quality + boarding + safe-loved-pampered; no prices.
92. Irma's Beauty Salón `ChIJ9ZNJ95hglIARdn0heKLIkj4` (Fresno) — warm bilingual neighborhood hair+nails salon, PHOTO-LIGHT: warm ROSE/coral-pink + warm GOLD + cream + deep berry, scissors/nail-polish/flower/sparkle motifs, Fraunces, owner Irma (hair+nails), 9-yrs-loyal-clients, se-habla-español (9th beauty_salon; warm rose-coral neighborhood, distinct from blush-gold-serif/mono-oxblood/emerald/pine/orchid/bronze-greige/navy-chrome siblings). 4.9/11; featured ornate nail-art photos; no prices/invented-services (hair+nails only). Hair-result face photos excluded.
93. Espresso Yourself `ChIJS3i2_ZLDyIARybgPlN4TaPY` (Las Vegas) — joyful little community coffee shop inside The LGBTQ+ Center, PHOTO-RICH: warm CREAM + espresso-brown ground lit by a TASTEFUL pride-SPECTRUM gradient (rainbow-steam cup logo), Fraunces, barista Chris personalizes every cup, REAL chalk-board menu+prices (Bad Romance/Rocket Man/Green Light energy drinks, 11 sodas, teas, vegan pastries), Grade-A health, community framing (5th coffee_shop; cream/espresso + joyful rainbow distinct from retro-brown-orange/sakura-pink/charcoal-matcha/sage-kraft siblings). 4.7/11; only chalk-board prices, no invented programs/percentages.
94. Sac City Plumbing `ChIJH7CAnr7QmoARDkk4ZHiTkr8` (Sacramento) — one-man honest plumber, PHOTO-FREE type-forward (all 4 Google photos rejected: 2 AI/stock-watermarked, 2 belong to a DIFFERENT same-named biz w/ 657 phone+Texas logo+24hr/commercial storefront): deep slate/indigo-blue + warm AMBER-honey + crisp white/concrete, Space Grotesk bold, big amber water-drop SVG hero + pipe-line pattern, owner Mike answers-his-own-phone/fast/honest/fair (4th plumber, FIRST photo-free; slate-indigo+amber distinct from vintage-cream-teal-copper/red-navy/teal-navy-copper siblings). 4.9/11; ONLY (916) phone, NO 24-7/commercial/water-heater/sewer claims, no invented prices.
95. The Noble House `ChIJQ1ZzKjRZ54YROY7y7mC3_Cs` (El Paso) — holistic wellness collective (sound baths/meditation/conscious events), PHOTO-LIGHT face-free crops: NOCTURNAL candlelit aubergine/wine-plum + candle-GOLD + terracotta-rust + cream, Cormorant, founder Norma, sound baths + somatic-meditation Thursdays 6:30 + healers-collective, sacred-geometry/crystal-sound-bowl/moon motifs (wellness/yoga lane; nocturnal-warm distinct from Corporate-Mind-Body sand-teal/Milagros bright-cream-terracotta-sage/Magic-Tree cool-plum-teal-aerial/Sunny golden-daytime/Puppy pink-mint). REAL 5.0/10 shown; NO medical claims (experiential only + 'not medical advice' disclaimer), NO invented yoga-timetable/prices; all photos face-free crops (bowls/candles/star/courtyard).
96. Lou's Auto Repair LLC `ChIJ-14RSdjDyIARKp4uCfTlnSc` (Las Vegas) — honest one-man neighborhood mechanic open 7 days, PHOTO-RICH (4 face-free work shots + 1 flagged owner photo): warm CHARCOAL/gunmetal + marigold-AMBER + concrete/cream + a single NEON-CYAN 'OPEN·7 days' hook (their real blue/red OPEN sign), Saira heavy grotesk, owner Lou, no-upsell/fair/explained-plainly/same-day/older-cars, wrench/gear/neon-OPEN motifs (9th auto; charcoal+amber+neon-cyan-OPEN distinct from lime/navy-red/orange/teal-chrome/crimson-graphite/black-gold/white-red/forest-green siblings). 4.9/10; no invented service-menu/prices, plate blurred, owner photo flagged.
97. City Pets Grooming Salon `ChIJe7quD6HRmoARq_e1C6LYYdM` (Sacramento) — cozy one-on-one boutique dog groomer, PHOTO-RICH (8 face-free dog shots): cheerful-calm cream/ivory + sunny HONEY-GOLD + soft DUSTY-BLUE + coral pop, Fraunces, groomer Jamie, ONE-family-at-a-time/cage-free/anxiety-friendly + SEASONAL-THEMED-PHOTOSHOOT-every-groom (CAMERA signature motif + city-skyline), themed-shoot bento gallery (garden/honeybee/xmas/valentine) (13th dog-care; honey-gold+dusty-blue+camera-hook distinct from blue/green-terracotta/orange/navy-gold/lavender/charcoal-coral/teal/cherry-pink/plum-gold/mint-blush/slate-rose/topaz-ruby siblings). REAL 5.0/10 shown; no prices, dogs-only (no cat/boarding/daycare/training inventions).
98. Two Seater Coffee `ChIJM3itMZn1XIYRdoybpWg5kiQ` (San Antonio) — FINAL IGFB row (91/91). Small craft coffee TRAILER, PHOTO-LIGHT brand-true: BOLD vermillion/red-orange + cream + charcoal + caramel, chunky retro-bubble 'two seater' wordmark (live type, drop-shadow) + Japanese katakana ツーシーター (their real logo), Baloo 2, made-in-house + miso-caramel-latte + seasonal-specials + super-nice-quick + free-water-for-skaters, cup/steam/retro-star motifs (6th coffee_shop; bold-vermillion + bubble-type + katakana distinct from retro-brown/sakura-pink/charcoal-matcha/sage-kraft/cream-rainbow siblings). REAL 5.0/11 shown; NO prices (blurry-reflection menu not used), only sourced drinks, honest hours (Wed/Thu closed).
— SKIPPED row 90: Express Tax Services-Notary Public `ChIJ5abyZuxeXIYR9adsPDbHTcM` (San Antonio) — notary+tax, 3.4/10 with multiple credible complaints (rude, 'making fun of what I needed help with', 'couldn't understand him', messed up papers) AND a complaint indicating possible legal advice on a child-custody matter (notary-overreach / unauthorized-practice-of-law red flag, Spanish-speaking clientele). No honest strengths-led story (positives directly contradicted by negatives). Per notary/immigration integrity gate + no-perfect-5/complaints rule: do NOT build a promotional site. 3rd skip.

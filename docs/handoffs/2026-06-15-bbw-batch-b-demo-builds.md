...
> Batch B. **56 of 101 done** (9 "email" prospects + 47 "IG/FB"). **45 IG/FB
> remain**, listed in `state/prospects/batches/IGFB-remaining-worklist.tsv` (work from row 47 down;
> rows 1–46 are done). **Chrome extension WORKS for Instagram (operator restarted it 2026-06-15);
